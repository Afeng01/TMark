...
export function useTabContextMenuActions({
  ...
  return useMemo(() => [
    {
      id: "moveToNewWindow",
      label: t("tabMenu.moveToNewWindow"),
      action: handleMoveToNewWindow,
      disabled: !canMoveToNewWindow,
    },
    {
      id: "pin",
      label: tab.isPinned ? t("tabMenu.unpin") : t("tabMenu.pin"),
      action: handlePin,
    },
    {
      id: "copyPath",
    ...
    {
      id: "closeAllUnpinned",
      label: t("tabMenu.closeAllUnpinned"),
