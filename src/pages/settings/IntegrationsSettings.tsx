...
function UsageGuideSettings() {
  const { t } = useTranslation("settings");

  return (
    <SettingsGroup title={t("integrations.usageGuide.title")}>
      <div className="space-y-3 text-xs text-[var(--text-secondary)] leading-relaxed">
        <p>{t("integrations.usageGuide.description")}</p>
        <div>
          <div className="font-medium text-[var(--text-color)]">{t("integrations.usageGuide.mcpTitle")}</div>
          <p>{t("integrations.usageGuide.mcp")}</p>
        </div>
        <div>
          <div className="font-medium text-[var(--text-color)]">{t("integrations.usageGuide.cliProvidersTitle")}</div>
          <p>{t("integrations.usageGuide.cliProviders")}</p>
        </div>
        <div>
          <div className="font-medium text-[var(--text-color)]">{t("integrations.usageGuide.aliceCliTitle")}</div>
          <p>{t("integrations.usageGuide.aliceCli")}</p>
        </div>
      </div>
    </SettingsGroup>
  );
