...
export class MockBridge implements Bridge {
  ...
  private handleRequest(request: BridgeRequest): BridgeResponse {
    ...
    switch (request.type) {
      ...
      case 'table.insert':
      case 'table.delete':
      // Phase 3: TMark-specific tools
      case 'tmark.insertMathInline':
      case 'tmark.insertMathBlock':
      case 'tmark.insertMermaid':
      case 'tmark.insertWikiLink':
      case 'tmark.cjkPunctuationConvert':
      case 'tmark.cjkSpacingFix':
