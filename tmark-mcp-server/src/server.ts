/**
 * TMark MCP Server - Exposes Tiptap editor APIs to AI assistants.
 */
...
/**
 * TMark MCP Server configuration.
 */
export interface TMarkMcpServerConfig {
  /** Bridge for communication with TMark app */
  bridge: Bridge;
  /** Server name */
  name?: string;
  /** Server version */
...
/**
 * TMark MCP Server - Main server class.
 * Implements McpServerInterface for testability.
 */
export class TMarkMcpServer implements McpServerInterface {
  ...
  constructor(config: TMarkMcpServerConfig) {
    this.bridge = config.bridge;
    this.serverName = config.name ?? 'tmark';
