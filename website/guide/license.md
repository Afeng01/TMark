...
TMark is released under the **ISC License** — one of the simplest and most permissive open-source licenses, functionally equivalent to MIT.
...
It was chosen for TMark because:
