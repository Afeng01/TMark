...
features:
  - icon:
      src: /icons/bot.svg
    title: AI 친화적
    details: AI 시대를 위해 만들어졌습니다. TMark는 MCP를 기본으로 지원합니다 — Claude, Codex, Gemini가 문서를 읽고, 제안하고, 편집할 수 있습니다. 플러그인이 필요 없습니다. 그냥 연결하고 협업하세요.
...
<div class="screenshots-grid">
  <div class="screenshot-card">
    ...
    <div class="caption">Claude Code에게 TMark에 직접 문서를 생성하도록 요청하세요</div>
  </div>
  <div class="screenshot-card">
  ...
  <div class="screenshot-card">
    <img src="/screenshots/content-received-by-tmark.png" alt="TMark에서 수신한 콘텐츠" loading="lazy" />
    <div class="caption">콘텐츠가 완전한 서식으로 TMark에 나타납니다</div>
  </div>
</div>
</div>
...
<div class="screenshots-grid">
  <div class="screenshot-card">
    <img src="/screenshots/editor-main.png" alt="TMark 리치 텍스트 에디터" loading="lazy" />
    <div class="caption">WYSIWYG 모드</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/source-mode.png" alt="TMark 소스 모드" loading="lazy" />
    <div class="caption">소스 모드 (F6)</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/dark-theme.png" alt="TMark 나이트 테마" loading="lazy" />
...
TMark는 Apple Silicon과 Intel을 기본 지원하는 macOS에 최적화되어 있습니다. 최신 버전을 다운로드하고 지금 바로 글쓰기를 시작하세요.

[TMark 받기 →](/ko/download)
