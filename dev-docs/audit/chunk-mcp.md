...
- **File:** `tmark-mcp-server/src/cli.ts:231,236`
...
- **File:** `tmark-mcp-server/src/tools/document.ts:75-79`
...
- **File:** `tmark-mcp-server/src/cli.ts` — 573 lines
- **File:** `tmark-mcp-server/src/bridge/types.ts` — 870 lines
- **File:** `tmark-mcp-server/src/index.ts` — 413 lines
...
- **File:** `tmark-mcp-server/src/tools/sections.ts:80`
...
- **File:** `tmark-mcp-server/src/tools/genies.ts:97-105`
...
- **File:** `tmark-mcp-server/src/tools/media.ts:99-108`, `159-165`
...
- **File:** `tmark-mcp-server/src/tools/mutations.ts:133-151`
...
- **File:** `tmark-mcp-server/src/cli.ts:225-246`
...
- **File:** `tmark-mcp-server/src/index.ts:386`
...
- **File:** `tmark-mcp-server/src/tools/selection.ts:193-204`
...
- **File:** `tmark-mcp-server/src/server.ts:291`
...
- **File:** `tmark-mcp-server/src/cli.ts:21` and `tmark-mcp-server/src/server.ts:59`
