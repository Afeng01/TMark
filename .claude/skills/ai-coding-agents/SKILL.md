...
**Note:** This skill documents both tools for reference. TMark development primarily uses **Claude Code CLI**. The Codex CLI sections are retained for completeness and cross-tool workflows.
